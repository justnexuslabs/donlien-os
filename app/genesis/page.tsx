      ...
      <section className="mx-auto grid max-w-[1600px] gap-5 px-4 pb-10 md:px-8 xl:grid-cols-[330px_1fr_380px]">
        <div className="grid gap-4">
          <HudPanel title="Command Status" accent="#E7BA50">
            ...
            <p className="uppercase text-yellow-100">Planned maximum Genesis supply</p>
            <p className="mt-5 text-sm leading-6 text-zinc-300">Public minting is not active. No LIENFT has been issued through this page.</p>
          </HudPanel>
          <HudPanel title="Collection Status" accent="#E7BA50">
            {["Mint price not announced", "Launch window not announced", "Chain and final mint structure not confirmed", "Final terms pending"].map((item) => (
        ...
        <div className="grid place-items-center py-10 text-center">
          <div className="hud-panel clip-hud max-w-xl p-8" style={{ "--accent": "#E7BA50" } as CSSProperties}>
            ...
            <p className="mt-5 text-lg leading-8">A separate planned collection of up to 300 founding LIENFTs. A LIEN ID is not automatically a Genesis LIENFT.</p>
        ...
        <div className="grid gap-4">
          ...
          <HudPanel title="Eligibility Notice" accent="#E7BA50">
            <p className="leading-7">Holographic LIEN ID holders may qualify for whitelist consideration. Eligibility does not guarantee a mint, allocation, or purchase opportunity.</p>
          </HudPanel>
        </div>
      </section>
