const faq = [
  ...
  ["Which roles can I choose?", "Season One public roles are Builder, Creator, and Strategist. Roles describe contribution and do not provide gameplay advantages."],
  ["How do I become a DEN Guardian?", "DEN Guardian is an earned trust designation for service, moderation, security, and community leadership. It cannot be selected or purchased; authorized DEN administrators appoint and revoke it."],
  ["Can I change my public role?", "Season One role changes after activation are not self-service. Contact support; future-season rules are not finalized."],
